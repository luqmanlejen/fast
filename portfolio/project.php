    ...
    <div class="singleproject-top">		
        <div class="container">
            <div class="ten columns">
                <div id="slider">	
                    <ul class="bxslider">
                        <li><img src="../dist/images/gallery/1.jpg" alt=""/></li>
                        <li><img src="../dist/images/gallery/2.jpg" alt=""/></li>
                        <li><img src="../dist/images/gallery/3.jpg" alt=""/></li>
                        <li><img src="../dist/images/gallery/4.jpg" alt=""/></li>
                    </ul>
                </div>
            </div>
